...
<div style="margin-top: 30px;margin-left: 100px;font-size: 30px;color: #6c757d">Admin-Home-Edit teacher</div>
...
if (isset($_GET['id'])) {
    ...
    echo "<input name='name'  type='text' value='{$tea['name']}' style='border: 1px solid #dad2d2;margin-left: 40px;padding-left: 10px;padding-top: 3px;padding-bottom: 3px;width: 240px'>"."<br><br>";
    ...
    echo "<button type='submit' name='update' style='margin-left: 120px;padding: 3px;width: 120px;color:#ffffff;background-color:#625C5CFF;border-radius: 6px; border: white'>update teacher</button>";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $id =$_GET['id'];
    $update = "update teachers set name ='" . $_POST['name'] . "',email='" . $_POST['email'] . "',phone='" . $_POST['phone'] . "',password='" . $_POST['password'] . "',image='" . $GLOBALS['im'] ."' WHERE id='$id';";
