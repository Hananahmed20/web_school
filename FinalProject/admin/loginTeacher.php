...
if(isset($_SESSION['teacher'])or (isset($_COOKIE['email'])and isset($_COOKIE['password']))){
...
<div class="container">
    <form action="teacher.php" method="post" >
        <h3 class="text-center" style="color:#a8b3c0;font-weight:bold; margin-top:80px;">Login Teacher</h3>
        <div class="form" >
