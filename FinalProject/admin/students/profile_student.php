...
<div style="margin-top: 30px;margin-left: 100px;font-size: 30px;color: #6c757d">Admin-Home-Student Profile</div>
...
//if (isset($_GET['id'])) {
//
//    echo "<table  style='margin-left: 200px;margin-top: 20px'>";
//    echo "<tr>";
//    echo "<th style=''>    </th>";
...
//    while ($tea = $result->fetch_assoc()) {
//        echo "<tr>";
//        echo "<td style='height: 300px;width: 200px;background-color: #0a53be;margin-left: 50px'>" . $tea['image'] . "</td>";
//        echo "<td>" . $tea['name'] . "</td>";
